...
const Hero = () => {
  return (
    <section id="home" className="pt-24 pb-12 lg:pt-32 lg:pb-20 bg-gradient-hero">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-slide-up">
            <div className="relative rounded-2xl overflow-hidden shadow-strong">
              <img
                src={heroImage}
                alt="AI Voice Technology for Business"
                className="w-full h-auto object-cover"
              />
              
              {/* Floating Elements */}
              <div className="absolute top-6 right-6 bg-background/90 backdrop-blur-sm rounded-lg p-3 shadow-medium animate-float">
                <div className="flex items-center gap-2">
            ...
            <div className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-secondary opacity-20 rounded-full blur-xl"></div>
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-gradient-primary opacity-20 rounded-full blur-xl"></div>
          </div>
        </div>
      </div>
    </section>
