...
const Hero = () => {
  ...
  return (
    <section className="relative z-10 px-5 pt-28 md:px-8 lg:pt-32">
      <div
        ref={ref}
        className={`rev-reveal ${inView ? "rev-in" : ""} mx-auto grid max-w-7xl items-center gap-14 lg:min-h-[calc(100vh-9rem)] lg:grid-cols-12 lg:gap-10`}
      >
        {/* Left — message */}
